    ...
    <>
      ...
      <main className="min-h-screen bg-cream">
        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            <h1 className="text-3xl font-bold text-ink">Find a roommate</h1>
          ...
          <div className="flex gap-2">
            <Link
              href="/roommates/mine"
              className="rounded-lg border border-ink/15 bg-white px-4 py-2.5 font-medium text-ink hover:border-grape/40 hover:text-grape"
            >
              My posts
            </Link>
            <Link
